...
![Test Image 1](Demo/Top_Ami.gif)　テキスト（Ami）が動くアニメーション:scssで実装  
  
  
![Test Image 2](Demo/MyFavorite.gif)　冊子のようなアニメーション：React Hoock、scssで実装  
...
![Test Image 3](Demo/display.gif)　ディスプレイ内のスクロール：scssで実装
